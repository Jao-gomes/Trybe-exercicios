...
// const listItens2 = document.getElementsByTagName('li');
...
// tenho que salvar numa variavel o texto que eu escrevi 
...
// const arrNode = Array.from(listItens);
// console.log(testList);

// testList[1].addEventListener('click', addClassTech);
// testList[2].addEventListener('click', addClassTech);
